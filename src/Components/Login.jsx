...
const Login = () => {
    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row h-screen">
            ...
            <div className="w-full lg:w-1/2 bg-cover bg-center relative" style={{ backgroundImage: `url(${img})` }}>
                {/* Blue Overlay Layer */}
                ...
                <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 text-center text-white">
                    <h1 className="text-3xl sm:text-4xl font-bold">{loginType === 'employee' ? 'Employee Login' : 'Admin Login'}</h1>
                    <p className="mt-4 text-lg sm:text-xl">Welcome to the HR Management System</p>
                    <p className="mt-4 w-full text-sm sm:text-base">Manage All <span className="text-lg font-semibold text-blue-500 hover:text-blue-700 transition duration-300">
                        HR Operations  </span> From The Comfort Of Your Home</p>
                </div>
            </div>

            {/* Right Box (Login Form) */}
            <div className="w-full lg:w-1/2 bg-gray-900 p-8 flex justify-center items-center">
                <div className="w-full max-w-md bg-gray-800 p-6 rounded-lg shadow-lg">
                    ...
                    {/* Login Form */}
                    <form>
                        <h2 className="text-2xl sm:text-3xl text-center text-white mb-6">{loginType === 'employee' ? 'Employee Login' : 'Admin Login'}</h2>

                        {/* Email */}
                        <div className="mb-4">
                            <label className="block text-sm sm:text-base text-gray-400">Email</label>
                        ...
                        {/* Password */}
                        <div className="mb-4">
                            <label className="block text-sm sm:text-base text-gray-400">Password</label>
                        ...
                        <div className="flex justify-between mb-6 text-sm sm:text-base text-gray-400">
